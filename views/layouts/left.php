        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Nueva venta', 'icon' => 'cart-plus text-green', 'url' => ['/site/index']],
                    ['label' => 'Ventas', 'icon' => 'shopping-cart text-orange', 'url' => ['/venta/index']],
                    ['label' => 'Repartidores', 'icon' => 'motorcycle text-red', 'url' => ['/repartidor/index']],
